...
import { SubProgram, Program } from 'apps/elicamps/src/models/Elicamps';
...
export class AddEditSubProgramComponent implements OnInit {
  ...
  public populateForm = (subProgram: any) => {
  ...
  public selectSubProgram = (value: any) => {
    const program: any = this.programList.find(found => found.id === value);
