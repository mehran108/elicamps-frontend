...
import { GROUP_PAYMENT_COL_DEFS, GROUP_LEADER_PAYMENT_COL_DEFS } from 'apps/elicamps/src/common/elicamps-column-definitions';
import { environment } from 'apps/elicamps/src/environments/environment';
import { Group } from 'apps/elicamps/src/models/Elicamps';
import { DeleteConfirmationDialogComponent } from 'apps/elicamps/src/modules/common/features/confirmation-dialog/delete-confirmation-dialog.component';
...
export class GroupPaymentComponent implements OnInit {
 public defaultColDef;
  ...
  public groupPaymentList: any;;
  public groupPaymentLeaderList: any;;
  private gridApi: any;
  private selectedGroup: any;
  public columnDefs: any = GROUP_PAYMENT_COL_DEFS;
  public columnDefsLeader: any = GROUP_LEADER_PAYMENT_COL_DEFS;
...
this.gridOptions = {
  ...
  public getSelectedGroup = (groupId: any) => {
    this.groupService.getElicampsGroup(groupId).subscribe((group: any) => {
  ...
  public getGroupPayments = (groupId: any) => {
    ...
    this.groupService.getAllPaymentGroupLeaderByGroupId(groupId).subscribe(res => {
      ...
      this.groupPaymentLeaderList.forEach((payment: any) => {
        payment.date = this.datePipe.transform(payment.date, 'short');
      });
    });
  }
  calculate = () => {
    ...
    this.groupPaymentLeaderList.forEach((res: any) => {
      if (res.active) {
