...
export class ListService {
  ...
  public CreateLookupValue(model: any) {
    return this.httpClient.post<any>(
      `${environment.appList}/createLookupValue`,
      model
    );
  }
  public UpdateLookupValue(model: any) {
    return this.httpClient.post<any>(
      `${environment.appList}/UpdateLookupValue`,
      model
    );
  }
  public DeleteLookupValue(model: any) {
    return this.httpClient.post<any>(
   ...
   * Get All Addins
   */
  public getAllAddins(params: any) {
  ...
  public getAllProgram(params: any) {
  ...
  public getAllSubProgram(params: any) {
  ...
  public uploadDoument(model: any): any {
  ...
  public uploadStudentProfile(model: any): any {
    if (model.studentEmail && model.files) {
      return this.httpClient.post(
