...
export class GroupService {
  private TripsMangerState: ReplaySubject<any>;
   public defaultColDef;
  constructor(public httpClient: HttpClient, public storage: LocalstorageService) {
    this.TripsMangerState = new ReplaySubject<any>();
  }

  // Add Elicamps Group
  public addElicampsGroup = (model: any) => {
    return this.httpClient.post<any>(`${environment.appGroup}/addGroup`, model);
  }
  ...
  setTripsMangerState = (tripsManager: any) => {
